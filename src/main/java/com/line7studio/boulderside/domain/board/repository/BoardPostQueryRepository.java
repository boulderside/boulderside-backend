...
public interface BoardPostQueryRepository {
    List<BoardPost> findBoardPostsWithCursor(Long cursor, String subCursor, int size, BoardPostSortType postSortType, boolean activeOnly, List<Long> excludedUserIds);
}
