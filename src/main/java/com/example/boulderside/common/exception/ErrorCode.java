...
public enum ErrorCode {
	...
	// External (E001~E099)
	EXTERNAL_API_ERROR("E001", "외부 API 호출에 실패했습니다.", HttpStatus.SERVICE_UNAVAILABLE),
	EMAIL_SEND_FAILED("E002", "이메일 전송에 실패했습니다.", HttpStatus.INTERNAL_SERVER_ERROR),
	PHONE_VERIFICATION_FAILED("E003", "휴대폰 번호 인증에 실패했습니다.", HttpStatus.INTERNAL_SERVER_ERROR),
	WEATHER_API_FAILED("E003", "날씨 API 호출에 실패했습니다.", HttpStatus.INTERNAL_SERVER_ERROR),
	UNKNOWN_ERROR("E999", "알 수 없는 오류가 발생했습니다.", HttpStatus.INTERNAL_SERVER_ERROR);
